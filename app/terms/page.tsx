...
export const metadata: Metadata = {
  title: "利用規約 | 東京受験学苑",
  description:
    "東京受験学苑のサービス利用規約です。サービスの利用条件や禁止事項、免責事項などの詳細をご確認ください。",
}
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-[#475569] leading-relaxed">
              当学苑は、サービスに関して適法性・正確性・有用性を保証しません。利用者自身の判断と責任でサービスをご利用ください。利用者に損害が生じた場合でも、当学苑の故意または重過失による場合を除き責任を負いません。
            </p>
          </div>
          <div>
        ...
        <div>
          ...
          <p className="text-sm text-[#475569] leading-relaxed">2025年4月1日 制定</p>
        </div>
